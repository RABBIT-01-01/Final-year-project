      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.severityContainer}>
            ...
            <SeverityButton level="Medium" isSelected={severityLevel === "Medium"} onPress={() => setSeverityLevel("Medium")} />
            <SeverityButton level="High" isSelected={severityLevel === "High"} onPress={() => setSeverityLevel("High")} />
          </View>
        </View>
